...
(function(e) {
    ...
    function() {
        ...
        e.fn.position = function(n) {
            ...
            1 === k.length && (k[1] = k[0]),
            "right" === n.at[0] ? b.left += m : "center" === n.at[0] && (b.left += m / 2),
            "bottom" === n.at[1] ? b.top += g : "center" === n.at[1] && (b.top += g / 2),
            p = t(T.at, m, g),
            b.left += p[0],
            b.top += p[1],
            this.each(function() {
    ...
    e.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(t, i, s) {
            ...
            for (c = s.snapElements.length - 1; c >= 0; c--)
                ...
                h - m > v || g > l + m || u - m > y || b > d + m || !e.contains(s.snapElements[c].item.ownerDocument, s.snapElements[c].item) ? (s.snapElements[c].snapping && s.options.snap.release && s.options.snap.release.call(s.element, t, e.extend(s._uiHash(), {
                    snapItem: s.snapElements[c].item
                })),
                s.snapElements[c].snapping = !1) : ("inner" !== f.snapMode && (n = m >= Math.abs(u - y),
                a = m >= Math.abs(d - b),
                o = m >= Math.abs(h - v),
                r = m >= Math.abs(l - g),
    ...
    function() {
        ...
        e.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function(t, i) {
            e.fx.step[i] = function(e) {
                ("none" !== e.end && !e.setAttr || 1 === e.pos && !e.setAttr) && (y.style(e.elem, i, e.end),
                e.setAttr = !0)
            }
        }),
        e.fn.addBack || (e.fn.addBack = function(e) {
